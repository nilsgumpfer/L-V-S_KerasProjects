...
with open('simple_image_classification_fgb_architecture_v5.json', 'w') as model_file:
...
# model.load_weights('simple_image_classification_fgb_weights_v5_run1.h5')
...
model.save_weights('simple_image_classification_fgb_weights_v5_run1.h5')
