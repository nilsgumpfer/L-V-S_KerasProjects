...
model = Sequential()
model.add(Conv2D(64, (3, 3), input_shape=input_shape, padding='valid'))
model.add(Activation('relu'))
...
with open('simple_image_classification_fgb_architecture_v4.json', 'w') as model_file:
...
# model.load_weights('simple_image_classification_fgb_weights_v4_run1.h5')
...
model.save_weights('simple_image_classification_fgb_weights_v4_run1.h5')
