...
with open('advanced_image_classification_fgb_architecture.json', 'w') as model_file:
...
# model.load_weights('adv_img_class_fgb_weights.h5')
...
model.save_weights('adv_img_class_fgb_weights_run1.h5')
